		...
		<div class="wrapper">
			...
			<div id="main" class="cf">
				...
				<div class="page-content">
                    ...
                    <h2 class="heading">
				Helmar Artwork >> T206 Series </h2>
                
				
                <p><center>
                <img src="images/cardPics/T206-Helmar_3_Front.jpg" alt="T206-Helmar" width=300/>
                <img src="images/cardPics/T206-Helmar_3_Back.jpg" alt="T206-Helmar" width=300/>
                </center></p>
...
<!-- edit series description here -->
		        		...
		        		<h3  class="heading">T206-Helmar</h2>
		        		<p>This card is part of the T206-Helmar series, a “living series” that is currently being expanded. Each card is sized about 1.625" x 2.65". The original artwork was accomplished using gouache paint. We are planning to offer a few different cards from the series each week until our supply is exhausted. They are available only as singles; never in full sets.</p>
...
<?php
	$i = 0;
	$R_cards = $db_main->query("SELECT * FROM cardList WHERE series = 'T206-Helmar'");
	if($R_cards !== FALSE){
		$R_cards->data_seek(0);
