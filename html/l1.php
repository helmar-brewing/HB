...
?>
			...
			<div id="main" class="cf">
				...
				<div class="page-content">
                    ...
                    <h2 class="heading">
				Helmar Artwork >> L1 Series </h2>
                
				
                <p><center>
                <img src="images/cardPics/L1-Helmar_43_Front.jpg" alt="L1-Helmar" width=300/>
                <img src="images/cardPics/L1-Helmar_43_Back.jpg" alt="L1-Helmar" width=300/>
                </center></p>
...
<?php
	$i = 0;
	$R_cards = $db_main->query("SELECT * FROM cardList WHERE series = 'L1-Helmar'");
	if($R_cards !== FALSE){
		$R_cards->data_seek(0);
