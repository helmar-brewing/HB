...
?>
			...
			<div id="main" class="cf">
				...
				<div class="page-content">
                    ...
                    <h2 class="heading">
				Helmar Artwork >> T3 Helmar </h2>
                
				
                <p><center>
                <img src="images/cardPics/T3-Helmar_3_Front.jpg" alt="T3-Helmar" width=300/>
                <img src="images/cardPics/T3-Helmar_3_Back.jpg" alt="T3-Helmar" width=300/>
                </center></p>
...
<!-- edit series description here -->
		        		...
		        		<h3  class="heading">T3 Helmar</h2>
		        		<p>This card is part of the T3-Helmar series, a “living series” that is currently being expanded. Each card is sized about 8.5” x 4.25". The original artwork was accomplished using either gouache paint or oil pastels. We are planning to offer a few different cards from the series each week until our supply is exhausted. They are available only as singles; never in full sets.</p>
...
<?php
	$i = 0;
	$R_cards = $db_main->query("SELECT * FROM cardList WHERE series = 'T3-Helmar'");
	if($R_cards !== FALSE){
		$R_cards->data_seek(0);
