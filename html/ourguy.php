		...
		<div class="wrapper">
			...
			<div id="main" class="cf">
				...
				<div class="page-content">
                    ...
                    <h2 class="heading">
				Helmar Artwork >> Our Guy </h2>
                
				
                <p><center>
                <img src="images/cardPics/Our_Guy_3_Front.jpg" alt="Our_Guy" width=300/>
                <img src="images/cardPics/Our_Guy_3_Back.jpg" alt="Our_Guy" width=300/>
                </center></p>
...
<!-- edit series description here -->
		        		...
		        		<h3  class="heading">Our Guy</h2>
		        		<p>This card is part of the Helmar-Our Guy series. This is an ongoing series and new designs are being continually added. Each card is 1.625" x 2.65". The Our Guy series is a colorful rendition of players from the early baseball era.  Each card shows the player in fine detail and wonderful color, just as the early artists would have liked their work to appear had the technology been available. We are planning to offer a few different cards from the series each week until our supply is exhausted. The total production will not exceed 25 sets. They are available only as singles; never in full sets.</p>
...
<?php
	$i = 0;
	$R_cards = $db_main->query("SELECT * FROM cardList WHERE series = 'Our_Guy'");
	if($R_cards !== FALSE){
		$R_cards->data_seek(0);
