...
?>
			...
			<div id="main" class="cf">
				...
				<div class="page-content">
                    ...
                    <h2 class="heading">
				Helmar Artwork >> L2 Helmar </h2>
                
				
                <p><center>
                <img src="images/cardPics/L2-Helmar_3_Front.jpg" alt="L2-Helmar" width=300/>
                <img src="images/cardPics/L2-Helmar_3_Back.jpg" alt="L2-Helmar" width=300/>
                </center></p>
...
<?php
	$i = 0;
	$R_cards = $db_main->query("SELECT * FROM cardList WHERE series = 'L2-Helmar'");
	if($R_cards !== FALSE){
		$R_cards->data_seek(0);
