...
?>
			...
			<div id="main" class="cf">
				...
				<div class="page-content">
                    ...
                    <h2 class="heading">
				Helmar Artwork >> H813-4 Boston Garter-Helmar </h2>
                
				
                <p><center>
                <img src="images/cardPics/H813-4_Boston_Garter-Helmar_3_Front.jpg" alt="H813-4_Boston_Garter-Helmar" width=300/>
                <img src="images/cardPics/H813-4_Boston_Garter-Helmar_3_Back.jpg" alt="H813-4_Boston_Garter-Helmar" width=300/>
                </center></p>
...
<!-- edit series description here -->
		        		...
		        		<h3  class="heading">H813-4 Boston Garter-Helmar</h2>
		        		<p>This card is part of the H813-4 Boston Garter-Helmar series of 45 cards. Each card is rather large at 8.25” x 4.25”. The original artwork was accomplished using gouache. Gouache is essentially watercolors with a white pigment that enables the paint to be opaque instead of translucent. We are planning to offer a few different cards from the series each week until our supply is exhausted. The total production will not exceed 20 sets. They are available only as singles; never in full sets.</p>
...
<?php
	$i = 0;
	$R_cards = $db_main->query("SELECT * FROM cardList WHERE series = 'H813-4_Boston_Garter-Helmar'");
	if($R_cards !== FALSE){
		$R_cards->data_seek(0);
