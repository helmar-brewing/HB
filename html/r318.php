...
?>
			...
			<div id="main" class="cf">
				...
				<div class="page-content">
                    ...
                    <h2 class="heading">
				Helmar Artwork >> R318 Helmar </h2>
                
				
                <p><center>
                <img src="images/cardPics/R318-Helmar_3_Front.jpg" alt="R318-Helmar" width=300/>
                <img src="images/cardPics/R318-Helmar_3_Back.jpg" alt="R318-Helmar" width=300/>
                </center></p>
...
<?php
	$i = 0;
	$R_cards = $db_main->query("SELECT * FROM cardList WHERE series = 'R318-Helmar'");
	if($R_cards !== FALSE){
		$R_cards->data_seek(0);
