...
?>
			...
			<div id="main" class="cf">
				...
				<div class="page-content">
                    ...
                    <h2 class="heading">
				Helmar Artwork >> T202 Series </h2>
                
				
                <p><center>
                <img src="images/cardPics/T202-Helmar_3_Front.jpg" alt="T202-Helmar" width=300/>
                <img src="images/cardPics/T202-Helmar_3_Back.jpg" alt="T202-Helmar" width=300/>
                </center></p>
...
<!-- edit series description here -->
		        		...
		        		<h3  class="heading">T202-Helmar</h2>
		        		<p>This card is part of the T202-Helmar series that currently consists of 12 cards. Each card is sized about 2.25" x 5.25". The original artwork was accomplished using gouache paint. They are available only as singles; never in full sets.</p>
...
<?php
	$i = 0;
	$R_cards = $db_main->query("SELECT * FROM cardList WHERE series = 'T202-Helmar'");
	if($R_cards !== FALSE){
		$R_cards->data_seek(0);
