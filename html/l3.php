...
?>
			...
			<div id="main" class="cf">
				...
				<div class="page-content">
                    ...
                    <h2 class="heading">
				Helmar Artwork >> L3 Cabinet Series </h2>
                
				
                <p><center>
                <img src="images/cardPics/L3-Helmar_Cabinet_3_Front.jpg" alt="L3-Helmar_Cabinet" width=300/>
                <img src="images/cardPics/L3-Helmar_Cabinet_3_Back.jpg" alt="L3-Helmar_Cabinet" width=300/>
                </center></p>
...
<?php
	$i = 0;
	$R_cards = $db_main->query("SELECT * FROM cardList WHERE series = 'L3-Helmar_Cabinet'");
	if($R_cards !== FALSE){
		$R_cards->data_seek(0);
