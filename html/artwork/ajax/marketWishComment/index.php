...
try{
	...
	$db_main->query("UPDATE userCardChecklist SET card_note_wish='".$_GET['comment']."' WHERE userid='".$user->id."' AND series='".$series."' and cardnum='".$_GET['cardnum']."' LIMIT 1");
	$db_main->query("UPDATE marketWishlist SET card_note='".$_GET['comment']."' WHERE userid='".$user->id."' AND series='".$series."' and cardnum='".$_GET['cardnum']."' LIMIT 1");
