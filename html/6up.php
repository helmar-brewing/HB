		...
		<div class="wrapper">
			...
			<div id="main" class="cf">
				...
				<div class="page-content">
                    ...
                    <h2 class="heading">
				Helmar Artwork >> Helmar 6 Up Die-Cut </h2>
                
				
                <p><center>
                <img src="images/cardPics/Helmar_6_Up_Die-Cut_3_Front.jpg" alt="Helmar_6_Up_Die-Cut" width=300/>
                <img src="images/cardPics/Helmar_6_Up_Die-Cut_3_Back.jpg" alt="Helmar_6_Up_Die-Cut" width=300/>
                </center></p>
...
<!-- edit series description here -->
		        		...
		        		<h3  class="heading">Helmar 6 Up Die-Cut</h2>
		        		<p>This card is part of the Helmar 6-Up Die-Cut Set that currently consists of 77 cards. Fifty-five of those cards feature big league teams while the remainder consists of seldom-seen minor league cities. Each card is sized at 4.5” x 6”, with some variance. We are planning to offer a few different cards from the series each week until our supply is exhausted. The total production will not exceed 25 sets, likely quite a few less. They are available only as singles; never in full sets.</p>
...
<?php
	$i = 0;
	$R_cards = $db_main->query("SELECT * FROM cardList WHERE series = 'Helmar_6_Up_Die-Cut'");
	if($R_cards !== FALSE){
		$R_cards->data_seek(0);
