		...
		<div class="wrapper">
			...
			<div id="main" class="cf">
				...
				<div class="page-content">
                    ...
                    <h2 class="heading">
				Helmar Artwork >> Helmar Trolley Card Series </h2>
                
				
                <p><center>
                <img src="images/cardPics/Helmar_Trolley_Card_10_Front.jpg" alt="Helmar_Trolley" width=300/>
                <img src="images/cardPics/Helmar_Trolley_Card_10_Back.jpg" alt="Helmar_Trolley" width=300/>
                </center></p>
...
<!-- edit series description here -->
		        		...
		        		<h3  class="heading">Helmar Trolley Card</h2>
		        		<p>This card is part of the Helmar Trolley Card Series that currently consists of 32 cards. Each card is sized about 5” x 2.4”. The original artwork was accomplished using gouache with digital. We are planning to offer a few different cards from the series each week until our supply is exhausted. The total production will not exceed 25 sets. They are available only as singles; never in full sets.</p>
...
<?php
	$i = 0;
	$R_cards = $db_main->query("SELECT * FROM cardList WHERE series = 'Helmar_Trolley_Card'");
	if($R_cards !== FALSE){
		$R_cards->data_seek(0);
